...
?>
    ...
    <form action ="" method="POST" class="editForm">
        <label for="fklantnr">Studenten ID:</label>
        <input type="text" name="studentID" value="<?php echo $info['id']; ?>" id="studentID"><br>
        ...
        <input type="submit" name="submit" value="Aanpassen" class="btnDetailSubmit">
    </form>
</div>
